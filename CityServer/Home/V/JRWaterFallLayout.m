...
static const CGFloat JRDefaultRowMargin = 4; // 行间距
static const CGFloat JRDefaultColumnMargin = 4; // 列间距
static const UIEdgeInsets JRDefaultEdgeInsets = {4, 4, 4, 4}; // edgeInsets
...
- (void)prepareLayout
{
    ...
    layoutHeader.frame =CGRectMake(0,0, ScreenWidth, 140);
